      ...
      >
        <div class="right_container">
          <el-card class="today_class">
            <h1>今日课堂</h1>
            <el-card class="today_class_card">
              <div class="class_time">
                <i class="el-icon-time"></i><span>时间：</span><span>14：00-16：00</span>
              </div>
              <div class="class_name">
                <i class="el-icon-notebook-2"></i><span>课程名称：</span><span>请弹吧（用右手）</span>
              </div>
              <div class="teacher_name">
                <i class="el-icon-user"></i><span>授课老师：</span><span>维贾君</span>
              </div>
            ...
            <el-card class="today_class_card">
              <div class="class_time">
                <i class="el-icon-time"></i><span>时间：</span><span>18：00-20：00</span>
              </div>
              <div class="class_name">
                <i class="el-icon-notebook-2"></i><span>课程名称：</span><span>请弹吧（用左手）</span>
              </div>
              <div class="teacher_name">
                <i class="el-icon-user"></i><span>授课老师：</span><span>吴克其</span>
              </div>
              <div class="classroom_name">
                <i class="el-icon-house"></i><span>地点：</span><span>C2教室</span>
              </div>
            </el-card>
            <el-pagination
          ...
          <el-card class="practicing_card">
            ...
            <el-card
              class="stu_card"
              body-style="display:flex; justify-content: start;"
            >
...
export default {
  ...
  methods: {
    openDetails (row) {
      const { id } = row
      this.$router.push("/teacher/studentDetails/" + id)
    }
  }
  //   mounted() {
  //     this.drawLine();
